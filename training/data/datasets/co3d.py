...
class Co3dDataset(BaseDataset):
    def __init__(
        ...
        # print("self.data_store",self.data_store['397_49980_98389'][0].keys()) #(['filepath', 'extri', 'intri'])
    ...
    def get_data(
        ...
        # print("img_per_seq",img_per_seq, len(metadata), seq_name)
        # exit(0)
        if ids is None:
        ...
        for anno in annos:
            ...
            if self.load_depth:
                ...
                mvs_mask = cv2.imread(mvs_mask_path, cv2.IMREAD_GRAYSCALE) > 128 # [H,W]
            ...
            extri_opencv = np.array(anno["extri"]) # [3，4]
            intri_opencv = np.array(anno["intri"]) # [3，3]
