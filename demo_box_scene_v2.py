...
# parser.add_argument('--model_path', type=str, default="/data1/lyq/logs/exp001/ckpts/checkpoint_3k_new_mvf_rgbmode_nomvf_2epoch.pt", help='Path to model checkpoint')
parser.add_argument('--model_path', type=str, default="/data1/lyq/logs/exp001/ckpts/checkpoint_3k_new_mvf_rgbmode_40epoch.pt", help='Path to model checkpoint')
...
parser.add_argument('--save_dir', type=str, default="/data1/lyq/CA1M_results_rgb_doublecheck", help='Output directory path')
...
for json_path in json_paths:
    ...
    for frame_ids in all_frame_ids:
        ...
        depth_path_list = [f"{data_root}/{scene_id}/depth/{int(i)}.png" for i in frame_ids]
        # print('image_names', image_names)
        # print('depth_path_list', depth_path_list)
        # exit(0)
