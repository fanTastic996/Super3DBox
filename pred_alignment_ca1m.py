...
def main():
    ...
    for seq in scenes:
        for i in range(2):
            ...
            box_dir = os.path.join(args.pred_root, 'selfz_box'+'_'+str(args.box_threshold*100))
            ...
            save_box_path = os.path.join(args.pred_root, 'box_eval_'+str(args.box_threshold*100))
            os.makedirs(save_box_path, exist_ok=True)
            with open(os.path.join(save_box_path, seq+"_"+str(i)+'.pkl'), 'wb') as f:
                pickle.dump(save_box_dict, f)
            print(f'saved box dict to {os.path.join(save_box_path, seq+"_"+str(i)+".pkl")}')
    
            # save final pkl
            final_pkl_path = os.path.join(args.pred_root, 'pkl', seq+"_"+str(i)+'_pred.pkl')
            os.makedirs(os.path.join(args.pred_root, 'pkl'+'_'+str(args.box_threshold*100)), exist_ok=True)
            print('final_pkl_path', final_pkl_path)
            print(os.path.join(args.pred_root, 'pkl'+'_'+str(args.box_threshold*100)))
            ...
            pkl_save = os.path.join(args.pred_root, 'pkl'+'_'+str(args.box_threshold*100), seq+"_"+str(i)+'_pred_aligned.pkl')
            with open(pkl_save, 'wb') as f:
                pickle.dump(final_pred_data, f)
            print(f'saved final pkl to {pkl_save}')
...
python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_new/  --pred_gt_root /data1/lyq/CA1M_results_rgb_new/gt_data/ --box_threshold 0.8

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_nomvf_doublecheck/  --pred_gt_root /data1/lyq/CA1M_results_rgb_nomvf_doublecheck/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_new_no2d3dfusion/  --pred_gt_root /data1/lyq/CA1M_results_rgb_new_no2d3dfusion/gt_data/ --box_threshold 0.8

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_new_nomvf_no2d3dfusion/  --pred_gt_root /data1/lyq/CA1M_results_rgb_new_nomvf_no2d3dfusion/gt_data/ --box_threshold 0.8


python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb/  --pred_gt_root /data1/lyq/CA1M_results_rgb/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_nomvf/  --pred_gt_root /data1/lyq/CA1M_results_rgb_nomvf/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_no2d3dfusion/  --pred_gt_root /data1/lyq/CA1M_results_rgb_no2d3dfusion/gt_data/ --box_threshold 0.6


python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_doublecheck/  --pred_gt_root /data1/lyq/CA1M_results_rgb_doublecheck/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_no2d3dfusion_doublecheck/  --pred_gt_root /data1/lyq/CA1M_results_rgb_no2d3dfusion_doublecheck/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_nomvf_doublecheck/  --pred_gt_root /data1/lyq/CA1M_results_rgb_nomvf_doublecheck/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_nomvf_no2d3dfusion_doublecheck/  --pred_gt_root /data1/lyq/CA1M_results_rgb_nomvf_no2d3dfusion_doublecheck/gt_data/ --box_threshold 0.6

python pred_alignment_ca1m.py   --pred_root /data1/lyq/CA1M_results_rgb_nomvf_no2d3dfusion/  --pred_gt_root /data1/lyq/CA1M_results_rgb_nomvf_no2d3dfusion/gt_data/ --box_threshold 0.6
