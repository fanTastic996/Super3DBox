...
def main():
    ...
    for seq in scenes:
        for i in range(4):
            ...
            #save final pkl
            final_pkl_path = os.path.join(args.pred_root, 'pkl_'+str(args.box_threshold*100), seq+"_"+str(i)+'_pred.pkl')
            ...
            final_pkl_path = final_pkl_path.replace('_pred', '_pred_aligned')
...
'''
CUDA_VISIBLE_DEVICES=2 python pred_alignment_scannetpp.py   --pred_root /data1/lyq/scannetpp_results_rgb/  --pred_gt_root /data1/lyq/scannetpp_results_rgb/gt_data/ --box_threshold 0.8

CUDA_VISIBLE_DEVICES=2 python pred_alignment_scannetpp.py   --pred_root /data1/lyq/scannetpp_results_selfz/  --pred_gt_root /data1/lyq/scannetpp_results_selfz/gt_data/ --box_threshold 0.8
'''